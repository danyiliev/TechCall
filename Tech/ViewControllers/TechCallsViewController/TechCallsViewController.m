...
//    manager.responseSerializer.acceptableContentTypes = [NSSet setWithObjects:@"application/json", @"text/json", @"text/javascript", @"text/html", nil];
    ...
    NSString *techCalls = [NSString stringWithFormat:@"https://%@/api/TechCalls/TechServiceCalls/%@?pServiceDate=%@", ipAddr, loginTech, [dateFormatter stringFromDate:[NSDate date]]];
