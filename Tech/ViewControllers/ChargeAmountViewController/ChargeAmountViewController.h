...
@interface ChargeAmountViewController : UIViewController {
    iMag *iReader;								//Step 5
}

@property (weak, nonatomic) IBOutlet UISegmentedControl *m_optionSegment;
...
@property (weak, nonatomic) IBOutlet UITextField *m_txtComments;
...
@property (weak, nonatomic) IBOutlet UIView *m_preAuthView;
@property (weak, nonatomic) IBOutlet UISwitch *m_preAuthSwitch;
@property (weak, nonatomic) IBOutlet UIView *m_switchView;
