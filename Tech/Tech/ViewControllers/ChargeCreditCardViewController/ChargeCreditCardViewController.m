...
- (void)ChargeCard {
    ...
    if (selectedSegmentIndex == 0)
    {
        ...
        //Main info
        Values = [NSArray arrayWithObjects:CreditCardDict, nameOnTheCard, [self.serviceCalls objectForKey:@"invoiceNum"], [self.serviceCalls objectForKey:@"SmName"], amountCharge, self.m_txtEmail.text, @"", @"True", nil];
    ...
    else if (selectedSegmentIndex == 1)
    {
        ...
        Values = [NSArray arrayWithObjects:CreditCardDict, self.m_txtName.text, [self.serviceCalls objectForKey:@"invoiceNum"], [self.serviceCalls objectForKey:@"SmName"], amountCharge, self.m_txtEmail.text, @"", @"True", nil];
        Keys = [NSArray arrayWithObjects:@"CreditCardInfo", @"ARName", @"InvoiceNumber", @"SMName", @"InvoiceAmount", @"Comments", @"Email", @"PreAuthorizeOnly", nil];
